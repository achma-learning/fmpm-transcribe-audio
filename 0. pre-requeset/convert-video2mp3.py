...
def convert_video_to_audio(video_path, audio_path):
    ...
    try:
        ...
        # -q:a 2: quality (0-9, lower is better, 2 is high quality)
        command = [
            'ffmpeg',
            '-i', str(video_path),
            '-vn',
...
def main():
    ...
    # Remove quotes if present (in case user copies path with quotes)
    ...
    # Create output folder name (original name + "_audio")
